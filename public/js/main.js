...
function togglemenu() {
    ...
    0 == $(".octex-navbar").hasClass("theme-horizontal") && (e <= 1200 && e >= 992 && $(".octex-navbar").addClass("navbar-collapsed"),
        e < 992 && $(".octex-navbar").removeClass("navbar-collapsed"))
}
...
$(document).ready(function () {
    ...
    if ($('[data-toggle="tooltip"]').tooltip(),
        ...
        $("#mobile-collapse").on("click", function () {
            $(".octex-navbar").toggleClass("navbar-collapsed")
        }),
        ...
        $("#m-search").on("keyup", function () {
            var e = $(this).val().toLowerCase()
                , s = $(this).val().length;
            $(".octex-inner-navbar > li").each(function () {
                var d = $(this).attr("data-username");
                if (d)
                    var i = d.toLowerCase();
                if (i) {
                    -1 !== i.indexOf(e) ? $(this).show() : $(this).hide(),
                        s > 0 ? $(".octex-menu-caption").hide() : $(".octex-menu-caption").show()
                }
            })
        }),
        ...
        !$(".octex-navbar").hasClass("theme-horizontal")) {
        var o = $(window)[0].innerWidth;
        o < 992 || $(".octex-navbar").hasClass("menupos-static") ? $(".navbar-content").slimScroll({
            setTop: "1px",
            size: "5px",
            wheelStep: 10,
            touchScrollStep: 90,
...
$(window).scroll(function () {
        ...
        var s = (this.attr("id"),
            ...
            , d = {
                ...
                HandleSubMenuTrigger: function () {
                    var s = $(window)
                        , d = s.width();
                    if (1 == $(".octex-navbar").hasClass("theme-horizontal"))
                        if (d >= 768) {
                            var i = $(".octex-inner-navbar .octex-submenu > li.octex-hasmenu");
                            i.off("click").off("mouseenter mouseleave").hover(function () {
                                $(this).addClass("octex-trigger")
                            }, function () {
                                $(this).removeClass("octex-trigger")
                            })
                        } else {
                            var i = $(".octex-inner-navbar .octex-submenu > li > .octex-submenu > li");
                            i.off("mouseenter mouseleave").off("click").on("click", function () {
                                0 === $(this).closest(".octex-submenu").length ? $(this).hasClass("octex-trigger") ? ($(this).removeClass("octex-trigger"),
                                    $(this).children(".octex-submenu").slideUp()) : ($(".octex-submenu > li > .octex-submenu > li.octex-trigger").children(".octex-submenu").slideUp(),
                                        $(this).closest(".octex-inner-navbar").find("li.octex-trigger").removeClass("octex-trigger"),
                                        $(this).addClass("octex-trigger"),
                                        $(this).children(".octex-submenu").slideDown()) : $(this).hasClass("octex-trigger") ? ($(this).removeClass("octex-trigger"),
                                            $(this).children(".octex-submenu").slideUp()) : ($(".octex-submenu > li > .octex-submenu > li.octex-trigger").children(".octex-submenu").slideUp(),
                                                $(this).closest(".octex-submenu").find("li.octex-trigger").removeClass("octex-trigger"),
                                                $(this).addClass("octex-trigger"),
                                                $(this).children(".octex-submenu").slideDown())
                            }),
                                $(".octex-inner-navbar .octex-submenu > li > .octex-submenu > li").on("click", function (e) {
                                    e.stopPropagation(),
                                        alert("click call"),
                                        0 === $(this).closest(".octex-submenu").length ? $(this).hasClass("octex-trigger") ? ($(this).removeClass("octex-trigger"),
                                            $(this).children(".octex-submenu").slideUp()) : ($(".octex-hasmenu li.octex-trigger").children(".octex-submenu").slideUp(),
                                                $(this).closest(".octex-inner-navbar").find("li.octex-trigger").removeClass("octex-trigger"),
                                                $(this).addClass("octex-trigger"),
                                                $(this).children(".octex-submenu").slideDown()) : $(this).hasClass("octex-trigger") ? ($(this).removeClass("octex-trigger"),
                                                    $(this).children(".octex-submenu").slideUp()) : ($(".octex-hasmenu li.octex-trigger").children(".octex-submenu").slideUp(),
                    ...
                    switch (e.SubMenuTrigger) {
                        case "click":
                            $(".octex-navbar .octex-hasmenu").removeClass("is-hover"),
                                $(".octex-inner-navbar .octex-submenu > li > .octex-submenu > li").on("click", function (e) {
                                    e.stopPropagation(),
                                        0 === $(this).closest(".octex-submenu").length ? $(this).hasClass("octex-trigger") ? ($(this).removeClass("octex-trigger"),
                                            $(this).children(".octex-submenu").slideUp()) : ($(".octex-submenu > li > .octex-submenu > li.octex-trigger").children(".octex-submenu").slideUp(),
                                ...
                                $(".octex-submenu > li").on("click", function (e) {
                                    e.stopPropagation(),
                                        0 === $(this).closest(".octex-submenu").length ? $(this).hasClass("octex-trigger") ? ($(this).removeClass("octex-trigger"),
                                            $(this).children(".octex-submenu").slideUp()) : ($(".octex-hasmenu li.octex-trigger").children(".octex-submenu").slideUp(),
                                                $(this).closest(".octex-inner-navbar").find("li.octex-trigger").removeClass("octex-trigger"),
                ...
                HandleMenuTrigger: function () {
                    var s = $(window)
                        , d = s.width();
                    if (1 == $(".octex-navbar").hasClass("theme-horizontal")) {
                        var i = $(".octex-inner-navbar > li");
                        d >= 768 ? i.off("click").off("mouseenter mouseleave").hover(function () {
                            if ($(this).addClass("octex-trigger"),
                                $(".octex-submenu", this).length) {
                                var e = $(".octex-submenu:first", this)
                                    , s = e.offset()
                                    , d = s.left
                                    , i = e.width();
                                $(window).height();
                            ...
                            $(this).hasClass("octex-trigger") ? ($(this).removeClass("octex-trigger"),
                                $(this).children(".octex-submenu").slideUp()) : ($("li.octex-trigger").children(".octex-submenu").slideUp(),
                                    $(this).closest(".octex-inner-navbar").find("li.octex-trigger").removeClass("octex-trigger"),
                                    $(this).addClass("octex-trigger"),
                                    $(this).children(".octex-submenu").slideDown())
                        })
                    ...
                    switch (e.MenuTrigger) {
                        case "click":
                            $(".octex-navbar").removeClass("is-hover"),
                                $(".octex-inner-navbar > li:not(.octex-menu-caption) ").on("click", function () {
                                    $(this).hasClass("octex-trigger") ? ($(this).removeClass("octex-trigger"),
                                        $(this).children(".octex-submenu").slideUp()) : ($("li.octex-trigger").children(".octex-submenu").slideUp(),
                                            $(this).closest(".octex-inner-navbar").find("li.octex-trigger").removeClass("octex-trigger"),
                                            $(this).addClass("octex-trigger"),
                ...
                HandleOffset: function () {
                    switch (e.themelayout) {
                        case "horizontal":
                            "hover" === e.SubMenuTrigger ? $("li.octex-hasmenu").on("mouseenter mouseleave", function (e) {
                                if ($(".octex-submenu", this).length) {
                                    var s = $(".octex-submenu:first", this)
                                        , d = s.offset()
                                        , i = d.left
                                        , o = s.width();
                                    $(window).height();
                            ...
                            }) : $("li.octex-hasmenu").on("click", function (e) {
                                if (e.preventDefault(),
                                    $(".octex-submenu", this).length) {
                                    var s = $(".octex-submenu:first", this)
                                        , d = s.offset()
    ...
    $("#mobile-collapse,#mobile-collapse1").click(function (e) {
        $(window)[0].innerWidth < 992 && ($(".octex-navbar").toggleClass("mob-open"),
            e.stopPropagation())
    }),
    $(window).ready(function () {
        var e = $(window)[0].innerWidth;
        $(".octex-navbar").on("click tap", function (e) {
            e.stopPropagation()
        }),
            $(".octex-main-container,.octex-header").on("click", function () {
                e < 992 && 1 == $(".octex-navbar").hasClass("mob-open") && ($(".octex-navbar").removeClass("mob-open"),
